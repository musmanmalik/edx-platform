"""
Management command to build the admin roles
"""
import datetime
import logging
...
class Command(BaseCommand):
    """ Management command to build the admin roles """
    help = '''
    Remove instructor role of internal admins on courses in their organization and add it on internal tagged courses
example:
