...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "marked as answer %(time_ago)s": "marqu\u00e9 comme r\u00e9ponse il y a %(time_ago)s", 
    "marked as answer %(time_ago)s by %(user)s": "marqu\u00e9 comme r\u00e9ponse il y a %(time_ago)s par %(user)s", 
    "minutes": "minutes", 
    "name": "nom", 
    "off": "arr\u00eat", 
    "on": "on", 
    ...
    "question posted %(time_ago)s by %(author)s": "question publi\u00e9e il y a %(time_ago)s par %(author)s", 
    "remove": "supprimer", 
