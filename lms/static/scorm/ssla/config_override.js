var sslaConfig = {
    ...
    popupMainContentMessageFailed: function() {
        return '<div style="background-color:rgb(250,250,250); width: 100%; height: 100%; display: table;"> <p style="font-family: \'Open Sans\', Arial, sans-serif; font-size: 14px; color: #000000; padding-top: 54px;">' + parent.gettext('It looks like your browser settings has pop-ups disabled.') + '<br>' + parent.gettext('The content takes place in a new window.') + '</p> <br><br> <button onclick="parent.ssla.ssla.popupManually();" style="background-color: #3385C7; color: white; padding: 1rem 2rem; font-family: \'Open Sans\', Arial, sans-serif; font-size: 14px; border-width: 0; font-weight: 700; border-color: #2s6a9f; border-radius: 5px;">' + parent.gettext('Launch pop-up to continue') + '</button></div>';
    },
